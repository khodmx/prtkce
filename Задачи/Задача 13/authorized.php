  ...
  <nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#252424">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav mr-auto">
        ...
        <button class="btn btn-outline-light" aria-hidden="true"
          style="margin-left:5px; width:175px; text-align: right" type="button" href="#"><i class="fa fa-user fa-lg align-items-center"
          style="margin-right: 8px" aria-hidden="true"></i>Личный кабинет</button>
      </ul>
    </div>
  </nav>
  <div class="dropdown">
